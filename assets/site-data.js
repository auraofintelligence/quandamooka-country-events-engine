window.QCEE_DATA = {
  ...
  events: [
    ...
    {
      id: "shippies-sunsets-pattern",
      name: "Shippies Sunsets",
      dateLabel: "Every Friday from 4pm",
      dateSort: "2026-01-09",
      status: "recurring",
      season: "Year-round Friday waterfront rhythm",
      place: "Little Ship Club",
      village: "Goompi / Dunwich",
      sector: "Waterfront hospitality and social nights",
      scale: "weekly club social",
      source: "Little Ship Club social calendar",
      sourceUrl: "https://littleshipclub.com.au/whats-on/social-calendar/",
      concise: "Weekly Friday waterfront session with pizza, drinks and an easy bayfront social rhythm at Little Ship Club.",
      loadTags: ["weekly", "Little Ship Club", "free entry", "waterfront", "Friday"],
      simulation: {
        movement: "Locals, visitors and ferry-linked arrivals build gradually through late afternoon, with light parking pressure and longer sunset dwell time around the bayfront club setting.",
        permissions: "Club trading settings, food service flow, responsible service, public timing accuracy and any courtesy-transport messaging need to stay clear.",
        aftercare: "Friday turnout, kitchen demand, sunset-session trade and whether the club keeps the recurring public listing active are the useful follow-up signals.",
        ancestor: "Useful waterfront-rhythm marker because it captures a steady weekly Dunwich social pattern rather than a one-off performance spike."
      }
    },
    {
    ...
    {
      id: "sunday-social-bowls-sesh-pattern",
      name: "Sunday Social Bowls Sesh",
      dateLabel: "Every Sunday from 4pm",
      dateSort: "2026-06-07",
      status: "recurring",
      season: "Year-round Sunday social rhythm",
      place: "Point Lookout Bowls Club",
      village: "Point Lookout",
      sector: "Social bowls and club hospitality",
      scale: "weekly casual club gathering",
      source: "Point Lookout Bowls Club",
      sourceUrl: "https://www.pointlookoutbowlsclub.com.au/whats-on/sunday-social-bowls-sesh-kj8wa-4cwsm-9bf7f-l87ex-d2976-4pxp4-f6dnt-9y8d9",
      concise: "Weekly barefoot bowls session with cold drinks and a relaxed late-afternoon community crowd on the green.",
      loadTags: ["weekly", "barefoot bowls", "Point Lookout", "Sunday session", "club social"],
      simulation: {
        movement: "Low-to-moderate late-afternoon arrivals gather around the greens, with short local stays and light spillover into the bar and bistro.",
        permissions: "Club operations, green availability, group-booking messaging, responsible service and clear recurring-listing wording.",
        aftercare: "Player turnout, group bookings, bar trade and whether the Sunday social pattern stays stable outside school-holiday peaks.",
        ancestor: "Useful everyday-sport marker because it captures a repeat low-stakes social rhythm rather than a single competition weekend."
      }
    },
    {
