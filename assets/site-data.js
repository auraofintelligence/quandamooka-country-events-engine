window.QCEE_DATA = {
  ...
  eventAutomation: {
    ...
    lastRunLabel: "6 June 2026, 4:40pm GMT+10 Brisbane / AEST.",
    sortAnchorDate: "2026-06-06",
  ...
  events: [
    ...
    },
    {
      ...
      source: "SeaLink event page",
      sourceUrl: "https://www.sealink.com.au/north-stradbroke-island/events/straddie-arts-trail/",
      concise: "Self-guided island arts trail with open studios, pop-ups, workshops, demonstrations, performances and market stalls.",
    ...
    },
    {
      ...
      dateLabel: "Recurring Sundays / holiday rhythm needs direct confirmation",
      dateSort: "2026-01-01",
      status: "recurring",
      season: "Year-round / visitor peaks",
      place: "Point Lookout Bowls Club / Home Beach area to confirm",
      village: "Point Lookout",
      sector: "Markets and stallholders",
      scale: "regular local market",
      source: "Existing noticeboard catalogue plus public social-travel references",
      sourceUrl: "ecosystem.html",
      concise: "Regular artisan and local market pattern. Operational times and organiser details need direct confirmation.",
      loadTags: ["stallholders", "Sunday", "local artists", "food", "visitor rhythm"],
      simulation: {
        movement: "Small recurring market flow with parking, bus stop, weather and stall layout questions.",
        permissions: "Organiser confirmation, stallholder approvals, food safety, public listing and wet-weather rules.",
